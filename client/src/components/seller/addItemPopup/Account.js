...
const Account = ({ selectedGame , setSelectedGame }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const data = {
            title , price , accountTitle , accountEmail , accountPassword , image , type : 3 , game : selectedGame
        }
        ...
        <div className='mt-6 overflow-auto'>
            <form className='flex flex-col gap-6' onSubmit={handleSubmit}>
                <div className='flex sm:flex-row flex-col items-center justify-between sm:gap-4 gap-6'>
                    <div className='flex flex-col gap-2 sm:flex-[0.6] w-full'>
                    ...
                    <div className='flex flex-col gap-2 sm:flex-[0.4] w-full'>
                ...
                <div className='flex flex-col gap-2'>
                        <label htmlFor="AccountTitle" className='text-primary font-semibold'>
                            Account Title
                        </label>
                        <input 
                        id='AccountTitle'
                        type="text"
                        placeholder='Enter title of account being sold'
                        value={accountTitle}
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    id='email'
                    type="text"
                    placeholder='Enter email of account being sold'
                    value={accountEmail}
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    id='Password'
                    type="text"
                    placeholder='Enter password of account being sold'
                ...
                <div>
                    <button
                    type='submit' 
                    className="btn-primary py-3 px-12 uppercase disabled:cursor-not-allowed"
